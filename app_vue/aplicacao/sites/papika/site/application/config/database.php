...
$db['server']['hostname'] = 'mysql3.ivinidesigner.com.br';
$db['server']['username'] = 'ivinidesigner';
$db['server']['password'] = 'iviniJIV23';
$db['server']['database'] = 'ivinidesigner';
