...
<div class="paginas">
    <div class="breadcumb">
        <p>Voce está em: <a href="#">Quero Alugar</a></p>
    </div>
    <h1>QUERO ALUGAR <span class="right" style="width:60px"><a href="#" id="diminui">A- </a><a id="aumenta" href="#">A+ </a></span></h1>
    <h2>Solicite-nos uma avaliação do seu imóvel. Teremos o maior prazer em atendê-lo.</h2>

    <p>Através de mecanismos efificientes e seguros faremos a locação do seu imóvel !</p>
